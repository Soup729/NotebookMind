...
type ImageData struct {
	...
	VisualPath string      `json:"visual_path,omitempty"` // 保存后的图像区域路径
	VisualType string      `json:"visual_type,omitempty"` // chart/table/diagram/photo/image/unknown
	VisualJSON string      `json:"visual_json,omitempty"` // VLM 结构化抽取结果
}
